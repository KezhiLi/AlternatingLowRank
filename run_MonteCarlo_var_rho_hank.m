...
%% Save data
save MC_results_rho_001_hank   N P K x_struct rho M_runs rho_list SMNR_emp SRER_ls SRER_ls_struct SRER_crlb SRER_crlb_struct  sq_x sq_n  sq_e_ls sq_e_ls_struct sq_e_crlb sq_e_crlb_struct
